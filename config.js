...
const CONFIG = {
  ...
  tasks: [
    {
      id:          "task1",
      scenario_nl: "Ik ben mijn badge kwijt en wil graag een nieuwe.",
    ...
    {
      id:          "task2",
      scenario_nl: "Ik ben zwanger en heb dit reeds aangegeven.  Ik heb gehoord dat ik, wanneer ik terug herneem gebruik kan maken van borstvoedingsruimtes.  Graag had ik hieromtrent wat meer info.",
    ...
    {
      id:          "task6",
      scenario_nl: "Ik wil graag als DJ in bijberoep starten.  Wat moet ik doen?",
    ...
    {
      id:          "task8",
      scenario_nl: "Ik was voorbije zaterdag aanwezig op een evenement in het kader van een jobbeurs.  In bijlage vind je de goedkeuring van mijn leidinggevende.  Kunnen jullie het nodige doen aub?",
    ...
    {
      id:          "task9",
      scenario_nl: "Ik ontving geen verkeersvoordelen voor mijn echtgenote.  Gelieve dit na te kijken.",
      scenario_fr: "",
    ...
    {
      id:          "task10",
      scenario_nl: "Wegens omstandigheden start ik binnenkort met loopbaanbegeleiding.  Hiervoor krijg ik blijkbaar een infosessie.  Wanneer gaat deze precies door?",
      scenario_fr: "",
    ...
    {
      id:          "task12",
      scenario_nl: "Ik werd papa!  Wat moet ik doen om mijn geboorteverlof in orde te brengen?",
      scenario_fr: "",
    ...
    {
      id:          "task13",
      scenario_nl: "Ik zie in mijn quota dat ik slechts 11 kredietdagen heb terwijl ik, volgens mij, recht heb op 13 kredietdagen.  Kan U dit bekijken?",
      scenario_fr: "",
    ...
    {
      id:          "task14",
      scenario_nl: "Ik herneem binnenkort na langdurige ziekte.  Om medische redenen wens ik graag deeltijds te werken.  Welke gevolgen heeft dit voor mijn loon?",
      scenario_fr: "",
    ...
    {
      id:          "task15",
      scenario_nl: "Voor mijn werkzaamheden heb ik toegang nodig tot de volgende HR-toepassing: …  Kan U dit in orde brengen?",
      scenario_fr: "",
