...
const CONFIG = {
  ...
  i18n: {
    fr: {
      ...
      welcomeBody: "<p style=\"background:#fef3c7;border-left:3px solid #d97706;padding:0.5rem 0.75rem;border-radius:0 4px 4px 0;margin-bottom:0.75rem;font-size:0.875rem;\"><strong>Attention</strong> — Complétez cette étude sur un ordinateur ou un portable (pas un smartphone). Ne fermez pas cette page et ne rafraîchissez pas le navigateur : vos réponses ne seraient pas conservées et vous devriez tout recommencer.</p><p>Cette étude dure au maximum 20 minutes. Votre participation nous aidera à améliorer les catégories du Service Desk RH, afin que vous puissiez trouver plus facilement la bonne rubrique pour vos questions RH.</p>",
    ...
    nl: {
      ...
      welcomeBody: "<p style=\"background:#fef3c7;border-left:3px solid #d97706;padding:0.5rem 0.75rem;border-radius:0 4px 4px 0;margin-bottom:0.75rem;font-size:0.875rem;\"><strong>Opgelet</strong> — Vul dit in op een computer of laptop (geen smartphone of tablet). Sluit de pagina niet en ververs de browser niet tijdens de studie: uw antwoorden worden anders niet bewaard en u moet helemaal opnieuw beginnen.</p><p>U werkt maximaal 20 minuten. Uw deelname helpt ons de categorieën van het HR Service Desk overzichtelijker te maken, zodat u sneller bij de juiste plek terechtkomt met uw HR-vragen.</p>",
